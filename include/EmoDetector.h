...
namespace emotime {
  ...
  class EmoDetector {
    ...
    public:
       ...
       *  @details
       */
      std::pair<Emotion, float> predictVotingOneVsAllExt(cv::Mat& frame, std::map<Emotion,float> &votes);
       ...
       *
       */
      std::pair<Emotion, float> predictMayorityOneVsAll(cv::Mat& frame, std::map<Emotion,float> &votes);
       ...
       */
      virtual std::pair<Emotion, float> predict(cv::Mat& frame, std::map<Emotion,float> &votes);
